...
---------------------------------------------------------------------------------
Question 1 - Machine Accuracy (float.py):
...
---------------------------------------------------------------------------------
Question 2 - Matrix Methods (crout.py):
...
---------------------------------------------------------------------------------
Question 3 - Interpolation (interpolation.py)
...
---------------------------------------------------------------------------------
Question 4 - Fourier Transforms (fourier.py)
...
This can be plotted against axis in t-domain:	x = np.linspace(-t_max,3*t_max,N)	using plt.plot(x,gh)

---------------------------------------------------------------------------------
Question 5 - Random Numbers (rand_no.py)
