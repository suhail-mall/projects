...
> This project is to find the best-fit parameters to model the survival probability of a muon neutrino undergoing oscillation between the muon and electron flavours. 
> The total observed muons is then the expected number of observations multiplied by the probability of oscillation from muon to muon flavours. 
...
>>> Hessian and covariance matrices, given a function and position. This is useful for finding the standard error in a variable assuming hte NLL is close to Gaussian at the minimm point.
>>> Various plotting functions


> parabolic_approximation.py
